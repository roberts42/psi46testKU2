...
const char *CTestboard::rpc_cmdName[] =
{
	...
	/*    67 */ "roc_SetDAC$vCC",
	/*    68 */ "roc_Pix$vCCC",
	/*    69 */ "roc_Pix_Trim$vCCC",
	/*    70 */ "roc_Pix_Mask$vCC",
	/*    71 */ "roc_Pix_Cal$vCCb",
	/*    72 */ "roc_Col_Enable$vCb",
	/*    73 */ "roc_Col_Mask$vC",
	/*    74 */ "roc_Chip_Mask$v",
	/*    75 */ "tbm_Enable$vb",
	/*    76 */ "tbm_Addr$vCC",
	...
	/*    85 */ "SetPixelAddressInverted$vb",
	/*    86 */ "CountReadouts$ii",
	/*    87 */ "CountReadouts$iii",
	/*    88 */ "CountReadouts$iiii",
	/*    89 */ "PH$iiiis",
	/*    90 */ "test_pixel_address$bii",
	/*    91 */ "testColPixel$bCC2C",
	/*    92 */ "Ethernet_Send$v3c",
	/*    93 */ "Ethernet_RecvPackets$I",
	/*    94 */ "PixelThreshold$iiiiiiiiiii",
	/*    95 */ "ChipThresholdConvert$iiiiiibb2i"
};
...
uint8_t CTestboard::Daq_Read(vectorR<uint16_t> &rpc_par1, uint8_t rpc_par2, uint16_t rpc_par3)
{ RPC_PROFILING
	uint8_t rpc_par0;
	try {
...
uint8_t CTestboard::Daq_Read(vectorR<uint16_t> &rpc_par1, uint8_t rpc_par2, uint16_t rpc_par3, uint32_t &rpc_par4)
{ RPC_PROFILING
	uint8_t rpc_par0;
	try {
...
void CTestboard::tbm1_Write(uint32_t rpc_par1, uint32_t rpc_par2, int32_t rpc_par3)
{ RPC_PROFILING
	try {
...
void CTestboard::tbm2_Write(uint32_t rpc_par1, uint32_t rpc_par2, int32_t rpc_par3)
{ RPC_PROFILING
	try {
...
void CTestboard::tbm_Write(uint32_t rpc_par1, uint32_t rpc_par2, int32_t rpc_par3)
{ RPC_PROFILING
	try {
...
int32_t CTestboard::ChipThresholdConvert(int32_t rpc_par1, int32_t rpc_par2, int32_t rpc_par3, int32_t rpc_par4, int32_t rpc_par5, bool rpc_par6, bool rpc_par7, vectorR<int32_t> &rpc_par8)
{ RPC_PROFILING
	int32_t rpc_par0;
	try {
